...
<table align="center">
  ...
  <tr><td><img src="https://img.idkwh.ct8.pl/mp3p-revival/1.png" width="320" height="240"></td><td><img src="https://img.idkwh.ct8.pl/mp3p-revival/2.png" width="320" height="240"></td>
  </tr>
</table>
</div>
...
- [European Version](https://img.idkwh.ct8.pl/mp3p-revival/wad/Metroid%20Prime%203%20Preview%20Channel%20%28Europe%29%20%28Revival%29.wad) (might not have every video in every language)

- [American Version](https://img.idkwh.ct8.pl/mp3p-revival/wad/Metroid%20Prime%203%20Preview%20Channel%20%28USA%29%20%28Revival%29.wad)
...
1. _Legally dump_ your own copy of the Metroid Prime 3 Preview channel
...
6. Open `html.arc` found in `00000002.app`, modify the first line of `video.js` to your custom URL, then repack the U8 archive. ([Wiimm's SZS Tools](https://szs.wiimm.de/wszst/) is recommended)
7. Repack the WAD
...
3. I get -1020 when installing the American WAD
    - The previous WAD had a ticket issue, please try redownloading it, as it should be fixed now.
